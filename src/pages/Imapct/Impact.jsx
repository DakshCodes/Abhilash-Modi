            ...
            <div className="impact-main" >
                <div className="wrapper">
                    ...
                    <ul className="carousel">
                        <li className="card">
                            <div className="img"><img src="https://i.pinimg.com/564x/5c/27/78/5c277875def19ff0f371d6a063625b13.jpg" alt="img" draggable="false" /></div>
                        </li>
                        <li className="card">
                            <div className="img"><img src="https://i.pinimg.com/736x/35/5e/e3/355ee36b63ce23e1a5530b5c50e13f4b.jpg" alt="img" draggable="false" /></div>
                        </li>
                        <li className="card">
                            <div className="img"><img src="https://i.pinimg.com/564x/5d/f6/c9/5df6c9991640ffcb8a7df726eddc5971.jpg" alt="img" draggable="false" /></div>
                        </li>
                        <li className="card">
                            <div className="img"><img src="https://i.pinimg.com/564x/b4/43/be/b443bec829113088a0b0525207e0fc77.jpg" alt="img" draggable="false" /></div>
                        </li>
                        <li className="card">
                            <div className="img"><img src="https://i.pinimg.com/564x/db/b1/e0/dbb1e0927a1dab2d59e287b9e4cf7665.jpg" alt="img" draggable="false" /></div>
                        </li>
                        <li className="card">
                            <div className="img"><img src="https://i.pinimg.com/564x/f6/88/7f/f6887fa19ff9acc601588d13b21263ee.jpg" alt="img" draggable="false" /></div>
                        </li>
                    </ul>
