...
const Impact = () => {
    ...
    useEffect(() => {
        ...
        const arrowBtns = document.querySelectorAll(".wrapper-impact svg");
    ...
    useEffect(() => {
        ...
        gsap.set(".wrapper-impact svg", {
            opacity: 0,
        })
        gsap.set(".carousel .card-impact", {
            x: -40,
            opacity: 0,
        })
        gsap.set(".one h1", {
        ...
        tl.to(".carousel-impact .card-impact", {
            x: 0,
            opacity: 1,
            stagger: 0.3,
        }).to(".wrapper-impact svg", {
            opacity: 1,
            stagger: 0.1,
            delay: -3
        }).to(".one h1", {
